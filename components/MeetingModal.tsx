    ...
    <Modal visible={visible} transparent animationType="fade">
      <View style={styles.overlay}>
        <View style={styles.modalContainer}>
          ...
          {/* Start Time */}
          <TouchableOpacity style={styles.timeCard} onPress={() => setPickerMode("start")}>
            <Text style={styles.label}>Start Time</Text>
            <Text style={styles.value}>{formatDateTime(meetingData.startTime)}</Text>
          </TouchableOpacity>

          {/* End Time */}
          <TouchableOpacity style={styles.timeCard} onPress={() => setPickerMode("end")}>
            <Text style={styles.label}>End Time</Text>
            <Text style={styles.value}>{formatDateTime(meetingData.endTime)}</Text>
          </TouchableOpacity>

          {/* Duration */}
          <TouchableOpacity style={styles.durationContainer} onPress={() => setDurationPickerVisible(true)}>
            ...
            <View style={styles.durationOverlay}>
              <View style={styles.durationPicker}>
                ...
                {[15, 30, 45, 60, 90, 120, 180].map((min) => (
                  <TouchableOpacity key={min} style={styles.durationOption} onPress={() => handleDurationSelect(min)}>
                ...
                <TouchableOpacity style={styles.durationCancel} onPress={() => setDurationPickerVisible(false)}>
          ...
          {/* Loading overlay inside modal container */}
          {loading && (
...
const styles = StyleSheet.create({
  ...
  modalContainer: {
    ...
    shadowRadius: 8,
    elevation: 5,
    position: "relative", // Required for absolute children like loading overlay
  },
  title: {
    fontSize: 18,
    fontWeight: "600",
  ...
  loadingOverlay: {
    ...
    alignItems: "center",
    zIndex: 9999,
    borderRadius: 18, // same radius as modalContainer to fit well
  },
});
